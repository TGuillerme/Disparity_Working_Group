...
Are all these methods the right tools to answer these questions (described in the intro) or are they meer “inductive fishing trips” and are actually not testing any of the hypothesis related to the disparity questions:

Can the data used in disparity studies actually test the phenomenon researchers are trying to capture?
E.g. for discrete morphological characters: disparity of fossilizable characters.
E.g. for morphometrics: disparity of the skull procrustes
E.g. for dtt: disparity of body/limb/beak length
Are  these data types enough to test disparity hypothesis or do we need more data/tone down the hypothesis?

Does the transformation of this data reflect our hypothesis? E.g. a morphospace as a pairwise matrix reflects the dissimilarity between the data, a morphospace based on an ordination reflects the variability within the data, a morphospace on both reflects the variability within the dissimilarity, are each method reflecting that?
...
Conclusion:
We need a more hypothesis driven way of analysing disparity. Disparity methods should be the tool for answering disparity hypothesis, not merely a description of the data.

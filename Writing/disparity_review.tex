...
To understand these nuances, it is important to remember that: (1) morphological disparity analysis are not new and much effort has been made in developing the our methods and (2) multidimensional analysis are by far not restricted to morphological data analysis and solutions to specific problems can be found in the literature that is not necessary focused on morphology (especially ecology and mathematics).

We believe that many of the caveats in morphological disparity analysis can arise when ``blindly'' applying methodological pipelines that can come at the expense of loosing sight of the actual biological question tested.

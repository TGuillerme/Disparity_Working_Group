...
% NC: how about something like "Analysing disparity in morphology data: best practice and future directions"
\bigskip
...
% NC: OK I've chopped this up a lot as it felt like you were repeating yourself quite a bit (e.g. you said here is what kinds of analyses people did in the 90s, and what they do now, then you had a section on here is what we defined disparity as in the 1980s and here is what we do now - so I've combined it all) and could say the same thing in half the space. Feel free to revert back.
...
%Even classical scholars recognised that NC: I'm unsure we need this qualifier, just get right to it!
Variation in the shape, form and function of organisms often follows discrete patterns rather than continuous gradients.
These patterns can be pictured as multidimensional spaces encompassing all the possible forms an organism can take, and where each individual region of this space is the result of a discrete combination of many variables.
...
% NC: I've tried to make the example clearer, but I'm unsure if it actually helps. Could cut the examples and go straight into the next sentence? Then the intro is just one paragraph.
One commonly used approach to analyse these discrete patterns, and to understand the processes that lead to them, is to analyse the disparity of the morphological characteristics of the group, often referred to as morphological disparity analysis.
...
Once you 
%TG: not sure about using "you" all the time. I feel it does add some patronising tone the whole yoke.
...
On the other hand, if the question focuses on the convergence between bat and bird wings, the homology of the traits to measure is more complex to define and the contour of the wings might more readily answer the question. % NC: This section might need more explanation and/or some more examples - %TG: here's a try.
...
\begin{itemize}
    ...
    % \item \textit{Are the data consistent?}
        %NC: Not suer I get this section. What do you mean by consistent???? Also does this fit into the "how much data" section or is it a seaprate consideration?

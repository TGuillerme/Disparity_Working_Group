...
Once one has a clear question, it is important to collect the appropriate data to avoid some major caveats.
For example, if a study focusses on the ecological adaptive radiation of a group, ecological traits are crucial and should be preferred over solely evolutionary traits.
...
Conversely if the question focuses on phylogenetic convergence aspects between different types of active flights, it might be more pertinent to use evolutionary traits that would have facilitated active flights within and between both groups (e.g. digits length, integumentary system, etc.).

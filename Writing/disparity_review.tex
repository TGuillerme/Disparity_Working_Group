...
\textcolor{blue}{This can be sometimes problematic when comparing the position of groups in multidimensional space, as the distances might not be linear (although this can sometimes be corrected  \citealt{cailliez1983})}.

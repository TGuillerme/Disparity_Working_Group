...
% TG: change naming of disparity through time
...
% TG: add guidance further than bootstraps.
...
% TG: add a disclaimer about the methods
...
% TG: redesign the figure 2 to only be PCA?/PCO?
...
% TG: change the terminology here and reference moms for parallels with ecology
...
% TG: insit that the distance metric is important (cite Lloyd)
...
% TG: add something about trait evolution model for pPCA
...
% TG: also add something about the model in ACE

...
## regressions
linear <- c("PGLS \\(PC \\~ trait\\)", "Partial Least Squares", "Canonical analysis \\(PCM style\\)", "lm", "Covariance ratio", "GLS", "distance PGLS", "multivariate regression", "linear regressions", "GLS multiple regression", "PICs", "Multivariate PGLS", "Non-linear regressions", "regression score", "Breush-Pagan")
tests <- multi.gsub(linear, "linear", tests)
...
## clustering
clustering <- c("Neares-neighbor test", "Cluster dendrogram analysis", "neigbor joining of the centroids", "Nearest neigbhor clustering", "Hierarchical clustering", "Branching random walks")
...
tests <- gsub("anova , LDA", "anova + LDA", tests)
